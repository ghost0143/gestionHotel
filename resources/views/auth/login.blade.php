              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Connecter vous pour ouvrir une session</p>
                  </div>
                  <form action="{{ route('auth.doLogin') }}" method="post" class="row g-3 needs-validation" novalidate>
                  @csrf
                    <div class="col-12">
