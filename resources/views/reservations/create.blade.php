            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card new-user">
                        <div class="card-body">
                            <h5 class="card-title">Faire une Reservation</h5>
                            @if ($errors->any())
                            ...
                            <form method="post" action="{{ route('reservation.create') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="nombrePersonne" type="number" value="{{ old('nombrePersonne') }}" class="form-control @error('nombrePersonne') is-invalid @enderror">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="startedDate" type="date" value="{{ old('startedDate') }}" class="form-control @error('startedDate') is-invalid @enderror">
                                    @error('startedDate')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input name="endedDate" type="date" value="{{ old('endedDate') }}" class="form-control @error('endedDate') is-invalid @enderror">
                                    @error('endedDate')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
